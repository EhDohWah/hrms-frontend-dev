            ...
            <div class="row gx-0">
              <div class="col-6">
                <div class="p-3 flex-fill border-end border-bottom">
                  ...
                  <h4 class="text-primary">{{ employeeStore.statistics.organizationCount.SMRU_count }}</h4>
                </div>
              </div>
              <div class="col-6">
                <div class="p-3 flex-fill border-bottom">
                  ...
                  <h4 class="text-secondary">{{ employeeStore.statistics.organizationCount.BHF_count }}</h4>
                </div>
              </div>
              <div class="col-6">
