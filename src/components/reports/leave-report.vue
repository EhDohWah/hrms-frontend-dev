    ...
    methods: {
        async loadSitesAndDepartments() {
            try {
                ...
                // Load department positions and extract unique departments
                await this.departmentPositionStore.fetchDepartmentPositions();
                const uniqueDepartments = this.departmentPositionStore.getAllDepartments;

                this.departments = uniqueDepartments.map(department => ({
                    id: department,
                    name: department,
                    value: department
                }));
