...
- **Selected Employees Table**: 
  ...
  - Individual employee details (name, staff ID, organization, department, position)
...
```javascript
{
  ...
  employeeFilters: {
    search: '',                      // Search query
    organization: null,                // Organization filter
...
- `useLookupStore`: Organization lookups
...
- [ ] Step 2: Organization filter works
