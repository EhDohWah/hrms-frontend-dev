...
export default {
    name: 'EmployeeTrainingHistoryReport',
    components: {
        ReportRow,
        OverallEmployeeTrainingHistoryReportModal
    },
    data() {
        return {
            report: {
    ...
    methods: {
        ...
        async exportExcel() {
            try {
                ...
                const excelBlob = await reportTrainingService.generateEmployeeTrainingHistoryReportExcel(
                    params.start_date,
                    params.end_date,
                    params.staff_id
                );
        ...
        async exportCSV() {
            try {
                ...
                const csvBlob = await reportTrainingService.generateEmployeeTrainingHistoryReportCSV(
                    params.start_date,
                    params.end_date,
                    params.staff_id
                );
