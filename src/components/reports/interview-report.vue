...
import OverallInterviewReportModal from '@/components/modal/reports/overall-interview-report-modal.vue';

export default {
    name: 'InterviewReport',
    components: {
        ReportRow,
        OverallInterviewReportModal
    },
    data() {
        return {
            report: {
    ...
    methods: {
        async preview() {
            try {
                ...
                this.$refs.overallInterviewReportModal.openModal();
