        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2 me-2">
            <a href="javascript:void(0);" class="btn btn-danger d-flex align-items-center"
              @click="confirmDeleteSelectedTrainings" :class="{ 'disabled': selectedRowKeys.length === 0 }">
          ...
          <div class="card flex-fill">
            <div class="card-body d-flex align-items-center justify-content-between">
              <div class="d-flex align-items-center overflow-hidden">
                <div>
                  <span class="avatar avatar-lg bg-primary rounded-circle"><i class="ti ti-book"></i></span>
                </div>
            ...
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="badge badge-soft-primary badge-sm fw-normal">
                  <i class="ti ti-arrow-wave-right-down"></i>
                  {{ trainingStats.totalTrainings ? ((trainingStats.completedTrainings / trainingStats.totalTrainings) * 100).toFixed(1) : 0 }}% of Total
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 d-flex">
          <div class="card flex-fill">
            <div class="card-body d-flex align-items-center justify-content-between">
              <div class="d-flex align-items-center overflow-hidden">
                <div>
                  <span class="avatar avatar-lg bg-warning rounded-circle"><i class="ti ti-hourglass"></i></span>
                </div>
                <div class="ms-2 overflow-hidden">
              ...
              <div>
                <span class="badge badge-soft-secondary badge-sm fw-normal">
                  <i class="ti ti-arrow-wave-right-down"></i>
                  {{ trainingStats.totalTrainings ? ((trainingStats.ongoingTrainings / trainingStats.totalTrainings) * 100).toFixed(1) : 0 }}% of Total
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="card-body d-flex align-items-center justify-content-between">
              ...
              <div>
                <span class="badge badge-soft-dark badge-sm fw-normal">
                  <i class="ti ti-arrow-wave-right-down"></i>
                  {{ trainingStats.totalTrainings ? ((trainingStats.upcomingTrainings / trainingStats.totalTrainings) * 100).toFixed(1) : 0 }}% of Total
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="card-body p-0">
          <div class="custom-datatable-filter table-responsive">
            ...
            <a-table v-else class="table datatable thead-light bordered-table" :columns="columns"
              ...
              :pagination="pagination" @change="handleChange" :bordered="true" :row-key="record => record.id">
              ...
              <template #bodyCell="{ column, record }">
                <template v-if="column.key === 'trainingName'">
                  <div class="d-flex align-items-center file-name-icon">
                    <div>
                      <h6 class="fw-medium">
                        <router-link :to="`/employee-training/training-details/${record.id}`">
                          {{ record.trainingName }}
                        </router-link>
                      </h6>
                      <router-link :to="`/employee-training/training-details/${record.id}`">
...
export default {
  data() {
    return {
      ...
      visibleColumns: ['trainingName', 'trainingType', 'startDate', 'endDate', 'duration', 'status', 'trainer', 'participants', 'action'],
  ...
  methods: {
    ...
    async deleteSelectedTrainings() {
      try {
        ...
        // For now, we'll just filter out the selected trainings
    ...
    // Update training statistics based on current trainings
    updateTrainingStats() {
      this.trainingStats = {
    ...
    // Fetch trainings (mock data for now)
      ...
      try {
        ...
        setTimeout(() => {
          this.trainings = [
            ...
            {
              id: 5,
              trainingName: 'Cloud Computing Fundamentals',
              trainingType: 'Technical',
