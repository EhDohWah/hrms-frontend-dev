              ...
              <div class="row gx-3">
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="miniLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/mini.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="horizontalLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/horizontal.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="horizontal-singleLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/horizontal-single.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="twocolumnLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/two-column.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="without-headerLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/without-header.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="horizontal-overlayLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/overlay.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="horizontal-sidemenuLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/menu-aside.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="stackedLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/stacked.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="modernLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/modern.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="transparentLayout">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/transparent.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <router-link to="/layouts/layout-rtl" class="theme-layout mb-3">
                    <span class="d-block mb-2 layout-img">
                      <img loading="lazy" decoding="async" src="@/assets/img/theme/rtl.svg" alt="img" />
                    </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="borderedCard">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/bordered.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="borderlessCard">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/borderless.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="shadowCard">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/shadow.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="compactSize">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/compact.svg" alt="img" />
                      </span>
                ...
                <div class="col-4">
                  <div class="theme-layout mb-3">
                    ...
                    <label for="hoverviewSize">
                      <span class="d-block mb-2 layout-img">
                        <img loading="lazy" decoding="async" src="@/assets/img/theme/hoverview.svg" alt="img" />
                      </span>
              ...
              <div class="d-flex align-items-center">
                <div class="theme-topbarbg me-3 mb-2">
                  ...
                  <label for="pattern1" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/pattern-01.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-topbarbg me-3 mb-2">
                  ...
                  <label for="pattern2" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/pattern-02.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-topbarbg me-3 mb-2">
                  ...
                  <label for="pattern3" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/pattern-03.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center flex-wrap">
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg1" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-01.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg2" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-02.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg3" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-03.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg4" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-04.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg5" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-05.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
                <div class="theme-sidebarbg me-3 mb-3">
                  ...
                  <label for="sidebarBg6" class="d-block rounded">
                    <img loading="lazy" decoding="async" src="@/assets/img/theme/sidebar-bg-06.svg" alt="img"
                      class="rounded" />
                  </label>
                </div>
              </div>
      ...
      <div class="row gx-3">
        <div class="col-6">
          <a href="javascript:void(0);" id="resetbutton" class="btn btn-light close-theme w-100"><i
              class="ti ti-restore me-1"></i>Reset</a>
        </div>
        <div class="col-6">
